...
func ApplyCareer(w http.ResponseWriter, req *http.Request) {
	...
	SignRes, err := http.Post("http://192.168.103.117:3000/DigitalSignature", "application/json", bytes.NewBuffer(jsonSign))
	if err != nil {
		fmt.Println(err)
		return
	}
	...
	PBFT_Res, err := http.Post("http://192.168.103.193:10000/req", "application/json", bytes.NewBuffer(jsonForPBFT))
	if err != nil {
